package top.dl.security.cache;
import cn.hutool.core.collection.ListUtil;
import lombok.AllArgsConstructor;
import org.springframework.stereotype.Component;
import top.dl.common.cache.RedisCache;
import top.dl.common.cache.RedisKeys;
import top.dl.security.properties.SecurityProperties;
import top.dl.security.user.UserDetail;

import java.util.List;
import java.util.Set;
/**
 * @author: minder
 * @createTime: 2025/04/25 9:01
 * @description:
 **/
@Component
@AllArgsConstructor

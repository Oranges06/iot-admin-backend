package net.maku.app.controller;
...
public class TUserController {
    ...
    @PreAuthorize("hasAuthority('app:resident:page')")
    ...
    @PreAuthorize("hasAuthority('app:resident:info')")
    public Result<TUserVO> get(@PathVariable("id") Long id){
        TUserVO data = tUserService.get(id);
    ...
    @PreAuthorize("hasAuthority('app:resident:save')")
    ...
    @PreAuthorize("hasAuthority('app:resident:update')")
    ...
    @PreAuthorize("hasAuthority('app:resident:delete')")
    ...
    @PreAuthorize("hasAuthority('app:resident:import')")
    public Result<String> importExcel(@RequestParam("file") MultipartFile file) {
        if (file.isEmpty()) {
            return Result.error("请选择需要上传的文件");
        }
        tUserService.importByExcel(file);
    ...
    @PreAuthorize("hasAuthority('app:resident:export')")
    public void export() {
        tUserService.export();
    }
}